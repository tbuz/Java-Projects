...
public class DezimalZuDual {
    ...
    public static int[] konvertiere(int dezimalZahl, int bits){
        ...
        //Wir brauchen ein Stellenzähler i:
        int i = 0;
        //Die Berechnung wird in wie vorgegeben in der while-Schleife ausgeführt
        while (dezimalZahl>0){
        	//Um in eine Binärzahl umzurechnen wird die Dezimalzahl immer wieder durch 2 geteilt und der Rest im Array notiert.
        	//Dabei teilt man mindestens so lange, bis die Dezimalzahl kleiner als 1 ist.
        	dualZahl[i] = dezimalZahl%basis;
